...
return [
    ...
    'attributes'           => [
        ...
        'gender'                => 'género',
        'hour'                  => 'hora',
        'inventory_big'         => 'inventario de bolas grandes',
        'inventory_small'       => 'inventario de bolas pequeñas',
        'last_name'             => 'apellido',
        'mass_ball_size'        => 'tamaño de bolas de masa',
        'message'               => 'mensaje',
        'minute'                => 'minuto',
        'mobile'                => 'móvil',
        'month'                 => 'mes',
        ...
        'product_id'            => 'producto',
        'quantity'              => 'cantidad',
        'receiver_id'           => 'usuario receptor',
        'role'                  => 'rol',
        'role_id'               => 'rol',
        'start_time'            => 'hora de inicio',
        'second'                => 'segundo',
        'sender_branch_id'      => 'sucursal emisora',
        'sex'                   => 'sexo',
        'subject'               => 'asunto',
        'terms'                 => 'términos',
        'time'                  => 'hora',
        'title'                 => 'título',
        'total_sale_big'        => 'venta total de bolas grandes',
        'total_sale_small'        => 'venta total de bolas pequeñas',
        'turn_id'               => 'turno',
        'username'              => 'usuario',
        'year'                  => 'año',
    ],
