    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <jet-input id="email" name="email" type="email" autocomplete="on" class="mt-1 block w-full" v-model="form.email" required autofocus />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <jet-button class="ml-4" :loading="form.processing" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Iniciar Sesión
                </jet-button>
            </div>
        </form>
